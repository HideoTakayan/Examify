...
import studentTranscriptRouter from "../studentTranscript.routes";
...
RouterV1.use("/exams/shuffle", shuffleRouter);
RouterV1.use("/teacher-students", teacherStudentsRouter);
RouterV1.use("/student/transcript", studentTranscriptRouter);
RouterV1.use("/grading", gradingRouter);
